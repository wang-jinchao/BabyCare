...
if __name__ == '__main__':
    ...
    parser.add_argument('-row', default='9', help='Row number of chessboard,6 as default')
    parser.add_argument('-col', default='6', help='Column number of chessboard,8 as default')
    parser.add_argument('-num', default='0',
                        help='Index of camera that you want to calibrate in your computer,0 as default')
    parser.add_argument('-flag', default='left',
